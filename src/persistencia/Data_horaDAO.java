...
public class Data_horaDAO {
	...
	private Data_horaDAO() throws ClassNotFoundException, SQLException, SelectException {
		...
		//newId=conexao.prepareStatement("select nextval('novo_cod_datahora')");
	...
	public void insert(Data_hora data_hora)throws InsertException{
		try {
			...
			insert.setInt(1, data_hora.getCod());
			insert.setDate(2, data_hora.getData_che());
			insert.setTime(3,data_hora.getHora_che());
			insert.setDate(4, data_hora.getData_sai());
			insert.setTime(5, data_hora.getHora_sai());
	...
	public List<Data_hora> selectAll() throws SelectException {
		...
		try {
			...
			while(rs.next()) {
				...
				data_hora.setData_che(rs.getDate("data_che"));
				data_hora.setHora_che(rs.getTime("hora_che"));
				data_hora.setData_sai(rs.getDate("data_sai"));
				data_hora.setHora_sai(rs.getTime("hora_sai"));
	...
	public void update(Data_hora data_hora)throws UpdateException{
		try {
			update.setDate(1, data_hora.getData_che());
			update.setTime(2, data_hora.getHora_che());
			update.setDate(3, data_hora.getData_sai());
			update.setTime(4, data_hora.getHora_sai());
