...
public class TabelaReserva_assento extends AbstractTableModel{
	...
	private String[] colunasAtributo= {"Código","Data da reserva","Numero da Poltrona","Código do Aeroporto"};
	...
	public Object getValueAt(int rowIndex, int columnIndex) {
		...
		case 3: {
			try {
				return sistema.selectAllReserva_assento().get(rowIndex).getCod_aero();
			} catch (SelectException e) {
				e.getMessage();
			}
		}
